...
## [1.10.0](https://github.com/Meniole/command-start-stop/compare/v1.9.0...v1.10.0) (2025-05-28)


### Features

* add Azure Functions integration and deployment workflows ([6f62c13](https://github.com/Meniole/command-start-stop/commit/6f62c130db7650edebf2a7d6243a37af62b3f267))
* add task access control configuration with price limits and refactor context creation ([5e82f61](https://github.com/Meniole/command-start-stop/commit/5e82f61be02dd189e008c07bb910aca530690daf))
* add transformedRole for handling Infinity in collaborator and contributor roles ([737b578](https://github.com/Meniole/command-start-stop/commit/737b578975cf9a2ebcb2f4c4146dbfb121feddee))
* aggregate price label and requirements errors ([088126b](https://github.com/Meniole/command-start-stop/commit/088126b234a67279a2198656438a6b3fae7e67a2))
* correct context and skip issues outside of the org ([2549597](https://github.com/Meniole/command-start-stop/commit/2549597b57ec35071acb9551975b510e40aae8e3))
* deploy url ([b8a6dfc](https://github.com/Meniole/command-start-stop/commit/b8a6dfc0c44d09862091d3e08658c2339e0bc96c))
* fine grain permission to start tasks ([e408abe](https://github.com/Meniole/command-start-stop/commit/e408abee2503a3bd47ce3db0e00127d57ef27117))
* implement task access control with price limits and add tests for default values ([6192aaf](https://github.com/Meniole/command-start-stop/commit/6192aaf0ba0e8454c0a9ae38d1ee0dc109eb9b40))
* make issues and PRs search configurable ([32e9280](https://github.com/Meniole/command-start-stop/commit/32e9280d5ccfdc7ef827158aafa410ebfc0c9b9f))
* manifest commands object ([aaf9c59](https://github.com/Meniole/command-start-stop/commit/aaf9c59f083b15f82c5348eb7495d87fa7eb2791))
* new error msg on missing required label ([ee4f7c6](https://github.com/Meniole/command-start-stop/commit/ee4f7c698f0e221381df7c73f56457e1ca4d22ea))
* new error msg on missing required label ([ef6198a](https://github.com/Meniole/command-start-stop/commit/ef6198ae51b9d8a39f61fe669144e8826e724924))
* remove self assign handler ([0a3d85c](https://github.com/Meniole/command-start-stop/commit/0a3d85ce58074c4aec99a418a07be14babdef9fc))
* required labels to start ([cc2b8f8](https://github.com/Meniole/command-start-stop/commit/cc2b8f83197bfb6ffc0d50db21a99e4e228a6927))
* requiredLabelsToStart config ([5326f20](https://github.com/Meniole/command-start-stop/commit/5326f20dbbe3e1a849487bc1d62572ce534fa0da))
* sdk and command interface ([6c1a13e](https://github.com/Meniole/command-start-stop/commit/6c1a13ec7f6047e32bcf518ea74333b8e5edb247))
* support cross-org ([bd63352](https://github.com/Meniole/command-start-stop/commit/bd63352b346491a9fb79d016ddf992f8cc88e6b3))
* switch to Bun and fix deploy ([688dfbb](https://github.com/Meniole/command-start-stop/commit/688dfbb4201280a9b5c847f3e984cd1d9457bcf6))
* switch to Bun and fix deploy ([6241af7](https://github.com/Meniole/command-start-stop/commit/6241af7be3f21449632960daa12a51a5182eb2e6))
* Task Access Control ([5c7da5b](https://github.com/Meniole/command-start-stop/commit/5c7da5b0edef641037e045d37a5892c7059e9d6a))
* task limit improvement ([6a013ba](https://github.com/Meniole/command-start-stop/commit/6a013ba9e6e2911c9ea5ffe8df0f0afe6592f692))
* task limit improvement ([f00a9c6](https://github.com/Meniole/command-start-stop/commit/f00a9c67b09a4d98fd9c2d2d49489ce41fbe2f0e))
* update style ([734f97b](https://github.com/Meniole/command-start-stop/commit/734f97bcb910452461fc87a7d5f54156b5a4149c))
* upgrade typebox ([1a32260](https://github.com/Meniole/command-start-stop/commit/1a32260f4b2be30f4adcb4f139392aadc38a4f06))
* upload source maps ([bb751d4](https://github.com/Meniole/command-start-stop/commit/bb751d4ba6af72458fb4409a2dd9352c0367b029))
* used ubiquity's knip-reporter ([30456d1](https://github.com/Meniole/command-start-stop/commit/30456d19d0f4a654dd54cd4e3f33b51927453b2b))
* used ubiquity's knip-reporter ([ac5603c](https://github.com/Meniole/command-start-stop/commit/ac5603cba276f0bac040e7d16e54d8dc1ab2aa74))


### Bug Fixes

* add dependency ([506906b](https://github.com/Meniole/command-start-stop/commit/506906bcdc68c5032a736871d7bbe53d726aa30a))
* add fallback methods for fetching issues/PRs ([16ba3a8](https://github.com/Meniole/command-start-stop/commit/16ba3a84835b5fc74d882fb4f0f5902491eec57a))
* added www. prefix ([0b63098](https://github.com/Meniole/command-start-stop/commit/0b630988ddd313bb09c2103c76f66138260beec3))
* aggregate error and source maps ([a9383df](https://github.com/Meniole/command-start-stop/commit/a9383df1c26ae0af7b1a08b2ec027823b8eed1c3))
* alternative way to list issues within network ([72cc120](https://github.com/Meniole/command-start-stop/commit/72cc1200d5ad7848c54eab4c878a53eb15f6452c))
* cleanup ([239d26e](https://github.com/Meniole/command-start-stop/commit/239d26e33eda370643f2be428b5334aae8fd0c82))
* condition for branch target changed to be either ref or workflow ref ([d556b02](https://github.com/Meniole/command-start-stop/commit/d556b0273717ad132279ad310612bc1d2a01ab51))
* condition for branch target changed to be either ref or workflow ref ([82bd846](https://github.com/Meniole/command-start-stop/commit/82bd84634edbb3aa7340802f95e172754bc7be45))
* **config:** add descriptions to JSON schema properties ([973ea32](https://github.com/Meniole/command-start-stop/commit/973ea32c0d4b817696789b667c11ef98315e10d1))
* **config:** add descriptions to JSON schema properties ([4fed7fd](https://github.com/Meniole/command-start-stop/commit/4fed7fd36b2fbb1107d28d5ec266986fa34bab7a))
* convert AssignedIssueScope to enum ([986261a](https://github.com/Meniole/command-start-stop/commit/986261acf7c62ed8f474ea4842fae4acbfe4a92f))
* deployment checkout branch ([a2088b9](https://github.com/Meniole/command-start-stop/commit/a2088b99605817da2cb6a77a5c8ae254f4fe9cab))
* disable start command for contributors ([d8c522a](https://github.com/Meniole/command-start-stop/commit/d8c522aff2cd57e5ef34e679f3c04c1c612e2d7a))
* disable start with different message on negative setting ([224611a](https://github.com/Meniole/command-start-stop/commit/224611a0bb95f5bb31a337c86baded8d9ee78523))
* ensure assignee is checked in userUnassigned handler ([0480ab3](https://github.com/Meniole/command-start-stop/commit/0480ab3aa6bcac468c9cbebcc08622b61a12fd5f))
* ensure assignee is checked in userUnassigned handler ([5659fc3](https://github.com/Meniole/command-start-stop/commit/5659fc3fa7c692f1f5bd7e79298202ac553775e9))
* error formatting ([597a745](https://github.com/Meniole/command-start-stop/commit/597a745350e240c5580c6d9cb7b6d5af80076913))
* fix format and type ([044f8a8](https://github.com/Meniole/command-start-stop/commit/044f8a87e652e19e1349c138dfdabad03c6d022f))
* fix jest tests to handle AggregateError ([7ef84db](https://github.com/Meniole/command-start-stop/commit/7ef84db2b61c2e9fe641c4793b935b315ce8a1d8))
* fixed failing test ([3e18c1b](https://github.com/Meniole/command-start-stop/commit/3e18c1bc97b1039db021130d096aa87ee3bb5022))
* handle 404 ([d09f2d4](https://github.com/Meniole/command-start-stop/commit/d09f2d4f535a51ce004806bfac8a0a07ae912c2e))
* handle fetch error ([2474312](https://github.com/Meniole/command-start-stop/commit/2474312f268ae015065f3f8000a9cb67ff735f3d))
* handle search API private repo ([d8fead7](https://github.com/Meniole/command-start-stop/commit/d8fead76df4723c8f387ffbae9314324481eb3a3))
* ignore dist ([2ba5e14](https://github.com/Meniole/command-start-stop/commit/2ba5e142969eb24b0d898c5eed44df1abb957588))
* ignore eslint config ([9155361](https://github.com/Meniole/command-start-stop/commit/9155361f8fcb61fd72b5fb74a8856089a13de55a))
* improve price label parsing and enhance task access control validation ([e5330ac](https://github.com/Meniole/command-start-stop/commit/e5330ac5b1923b84e3a5bbd1cd5ab18c4dc027cf))
* **issue:** handle 404 status in fetch pull request reviews ([82064c5](https://github.com/Meniole/command-start-stop/commit/82064c543782138221213a80455e68ba110f625c))
* linked pull-requests on tasks that cannot be started get closed ([c0dd452](https://github.com/Meniole/command-start-stop/commit/c0dd45212298943fc8efdf0558240f11df6bcadb))
* linked pull-requests on tasks that cannot be started get closed ([b36b79b](https://github.com/Meniole/command-start-stop/commit/b36b79b9e55279e407295e02ad4c95cdf05a5012))
* linking a pull-request to un un-priced task does not get close ([1253448](https://github.com/Meniole/command-start-stop/commit/125344841d7748977fd9616fe25b092033b0e20b))
* logic to retrieve pull-requests pending for a user updated ([e5259f1](https://github.com/Meniole/command-start-stop/commit/e5259f16f1e2ab931383152a8d749c21d0720327))
* member role inside of given repository checks ([89170cf](https://github.com/Meniole/command-start-stop/commit/89170cfb8f5cfbe2ef0c80b53bc637701cb5e616))
* message formatting ([982a3f5](https://github.com/Meniole/command-start-stop/commit/982a3f56413c79d5991aacdbcdab88b4efc6bed7))
* messages telling the user it cannot be using `/start` are now displayed as `warnings` ([ea95869](https://github.com/Meniole/command-start-stop/commit/ea9586931d674685cf2b73c38ec1d7821d359e06))
* ncc build ([dee590e](https://github.com/Meniole/command-start-stop/commit/dee590e2400833ed9504ff15b7a02fe9a7c8575c))
* ncc build ([29c2aef](https://github.com/Meniole/command-start-stop/commit/29c2aefeeadf5b134edfc25e05a2e2d85bbdc442))
* prevent bot from double posting messages ([9c40d09](https://github.com/Meniole/command-start-stop/commit/9c40d09bfc0c4ec178bb874afc03c57409ffe7ec))
* pricing error do not close the linked pull-request ([9f97c8e](https://github.com/Meniole/command-start-stop/commit/9f97c8e15ec1f06c3dd2be6ae82d5632bf714c2c))
* process review comments ([8fcedd9](https://github.com/Meniole/command-start-stop/commit/8fcedd9cc4ba3860a50b6835d8b8345cbc27e9f1))
* proper user assign on pull-request body edit ([2a85f91](https://github.com/Meniole/command-start-stop/commit/2a85f918fb576e8b30bb0fbb7bc47520956bb797))
* pull-request fetch for private user profiles ([b960b84](https://github.com/Meniole/command-start-stop/commit/b960b847087101e02dc8a2cabaac48d463966e85))
* query network in getAllPRs ([58fd4da](https://github.com/Meniole/command-start-stop/commit/58fd4da3ecb986b9a7bdcdbfd60aca5e96e6da8c))
* regenerate bun lock file ([788b468](https://github.com/Meniole/command-start-stop/commit/788b468217d21cef23e0f75a98efb0d0b70de2d2))
* removed deadline message on issue assigned ([f9a97ff](https://github.com/Meniole/command-start-stop/commit/f9a97ff319c0246cc5320aa836d716b1faccd48a))
* removed deadline message on issue assigned ([f9c38e9](https://github.com/Meniole/command-start-stop/commit/f9c38e9c7e1b40340919b5cf6eaaf401a6c3bcc5))
* removed debug lines ([ad20e32](https://github.com/Meniole/command-start-stop/commit/ad20e32526c6a9bf1ec2d87f8558e4aeb2b62e0c))
* renamed checkIssues to assignedIssueScope ([87e7b16](https://github.com/Meniole/command-start-stop/commit/87e7b16f334f7dec5a1ee34f01b9611b1e120ace))
* revert change in package.json ([8bf9f6f](https://github.com/Meniole/command-start-stop/commit/8bf9f6f672e28ce1d679d9a6ed3a011e7d9e9f74))
* simplified member role in configuration ([5fb457d](https://github.com/Meniole/command-start-stop/commit/5fb457de874a57300671c2848460406bbb0626c1))
* switch back to CJS ([5f81ebf](https://github.com/Meniole/command-start-stop/commit/5f81ebfd2aa3c89f2004dc8f75539dfbd9d31fdd))
* tests ([e4977d0](https://github.com/Meniole/command-start-stop/commit/e4977d0538ffdd8f025db8743d235889de73fc8d))
* tests ([1e47186](https://github.com/Meniole/command-start-stop/commit/1e471860392303cc8f01c4f99344b8be87686a87))
* tests ([c2b42a4](https://github.com/Meniole/command-start-stop/commit/c2b42a4745dd1f3bc11b210be9ff968a7bcaad62))
* the pull-request author is now the user assigned instead of the editor of the PR body ([7023f84](https://github.com/Meniole/command-start-stop/commit/7023f848b7d9ae214f8e823646d9924f3c8d6bc4))
* the stop commands are counted by assignment periods ([35f62c2](https://github.com/Meniole/command-start-stop/commit/35f62c2ad09255f32f626a8af5022ed661155913))
* the user role is determined from the repo when unavailable from organization ([fa4692b](https://github.com/Meniole/command-start-stop/commit/fa4692b76ca37de3744eaac78e549f6f2c89cb93))
* undo changes in manifest ([3827d28](https://github.com/Meniole/command-start-stop/commit/3827d28303a1d36e7668809194f6c9963c2a3140))
* update mock handlers ([0953019](https://github.com/Meniole/command-start-stop/commit/0953019c1c0f1b84ed837d8ab65c5ae1072cd9b6))
* update octokit method namespace ([3d760e3](https://github.com/Meniole/command-start-stop/commit/3d760e37911f24c4d61601bc74960d742396b36b))
* update role transformation and logging for task limits ([e2a5da0](https://github.com/Meniole/command-start-stop/commit/e2a5da08c3e389489da1e1395f70d10538a2048e))
* update yarn.lock ([910ebf0](https://github.com/Meniole/command-start-stop/commit/910ebf08767b9905d399152f832d2b90d5857423))
* updated yarn.lock ([0a6bd74](https://github.com/Meniole/command-start-stop/commit/0a6bd743a63ee756c63d866b16453f31855422cf))
* upgrade bun regenerate lock file ([3ed0b7e](https://github.com/Meniole/command-start-stop/commit/3ed0b7ec06d96f7f97cb0a9853fcd675b00608fa))
* used API to query orgs where the app is installed ([cd96022](https://github.com/Meniole/command-start-stop/commit/cd960229256da8a60d4c5138b014041725be8e9b))
* users now can start again after a `/stop` command ([d80c772](https://github.com/Meniole/command-start-stop/commit/d80c7727c66dd53e7317b4eeb47b45c20dcbc33a))
* validate presence of price label in issue before checking requir… ([651d84c](https://github.com/Meniole/command-start-stop/commit/651d84c764cb8a3f766b914017ed0d179540d62f))
* validate presence of price label in issue before checking requirements ([9b37967](https://github.com/Meniole/command-start-stop/commit/9b37967cd7527f8853f6baa6c763c58f48240e4b))
* yarn v1 ([7deffaf](https://github.com/Meniole/command-start-stop/commit/7deffaf3d91385468e3a2ccf3b91c7d89c47175a))
